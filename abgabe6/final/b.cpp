...
/*
 * the function spline calculates x for coefficients a,b,c,d and knots x_i
...
/*
 * subtracts the background from the raw data and output to file "profile_cmb.dat"
 */
